    ...
    return (
        <main className="card grid-container grid-x align-center about">
            ...
            <section className="card-section">
                ...
                <p className="aboutMe">Learn more about my skills and experience <a className="resumeLink" href="https://drive.google.com/file/d/1t6E71_lQpwCScM0X8OtvQ4-9fXy04nSI/view?usp=sharing">here</a>.</p>
